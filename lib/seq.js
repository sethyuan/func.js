...
function concat() {
  ...
  var _iterator6, _isArray6, _i6, _ref6, gen, _iterator7, _isArray7, _i7, _ref7, x;

  return _regeneratorRuntime.wrap(function concat$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        _iterator6 = generators, _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _getIterator(_iterator6);
      ...
      case 11:
        gen = _ref6;
        _iterator7 = gen, _isArray7 = Array.isArray(_iterator7), _i7 = 0, _iterator7 = _isArray7 ? _iterator7 : _getIterator(_iterator7);
...
function mapcat(f, generator) {
  var _iterator8, _isArray8, _i8, _ref8, x, _iterator9, _isArray9, _i9, _ref9, y;

  return _regeneratorRuntime.wrap(function mapcat$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        _iterator8 = generator, _isArray8 = Array.isArray(_iterator8), _i8 = 0, _iterator8 = _isArray8 ? _iterator8 : _getIterator(_iterator8);
      ...
      case 11:
        x = _ref8;
        _iterator9 = f(x), _isArray9 = Array.isArray(_iterator9), _i9 = 0, _iterator9 = _isArray9 ? _iterator9 : _getIterator(_iterator9);
  ...
  return _regeneratorRuntime.wrap(function partition$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 2:
        i = 0;
        buffer = new Array(n);
        _iterator10 = generator, _isArray10 = Array.isArray(_iterator10), _i10 = 0, _iterator10 = _isArray10 ? _iterator10 : _getIterator(_iterator10);
...
function interleave() {
  ...
  var done, res, _iterator12, _isArray12, _i12, _ref12, x;
  ...
  return _regeneratorRuntime.wrap(function interleave$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 3:
        ...
        done = res.reduce(function (prevDone, _ref13) {
        ...
        _iterator12 = res, _isArray12 = Array.isArray(_iterator12), _i12 = 0, _iterator12 = _isArray12 ? _iterator12 : _getIterator(_iterator12);
