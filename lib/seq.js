...
function interleave() {
  ...
  var finished, nextItems, isDone, res, _iterator13, _isArray13, _i13, _ref13, x;

  return _regeneratorRuntime.wrap(function interleave$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        isDone = function isDone(prevDone, _ref14) {
          var done = _ref14.done;

          return prevDone || done;
        };

        nextItems = function nextItems(gen) {
          return gen.next();
        };
